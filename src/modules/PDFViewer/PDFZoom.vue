...
<script>
import ZoomInIcon from '@/assets/svg/icon-zoom-in.svg'
import ZoomOutIcon from '@/assets/svg/icon-zoom-out.svg'
import ExpandIcon from '@/assets/svg/icon-expand.svg'
import ShrinkIcon from '@/assets/svg/icon-shrink.svg'
